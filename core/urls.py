...
from core.mobile_views import HomeView
...
urlpatterns = patterns(
    ...
    url(r'^projects/(\d+)/delete/$', views.delete_project,
        name='delete_project'),
    ...
    url(r'^time/project/(\d+)$', views.time_project_api,
        name="time_project_api"),
    url(r'^time/hours/(\d+)$', views.time_hours_api, name="time_hours_api"),
    url(r'^time/description/(\d+)$', views.time_description_api,
        name="time_description_api"),
    url(r'^time/track_date/(\d+)$', views.time_track_date_api,
        name="time_track_date_api"),
    url(r'^time/tag/$', views.time_tag, name="time_tag")
)
